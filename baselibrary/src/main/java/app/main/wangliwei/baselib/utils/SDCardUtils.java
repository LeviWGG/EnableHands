...
/**
 * Created by wangliwei on 2018/5/1.
 */
...
public final class SDCardUtils {
    ...
    public static List<String> getSDCardPaths(final boolean removable) {
        ...
        StorageManager sm =
                (StorageManager) BaseUtils.getApp().getSystemService(Context.STORAGE_SERVICE);
        try {
    ...
    public static List<String> getSDCardPaths() {
        StorageManager storageManager = (StorageManager) BaseUtils.getApp()
