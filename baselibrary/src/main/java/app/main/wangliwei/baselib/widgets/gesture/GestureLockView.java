package app.main.wangliwei.baselib.widgets.gesture;
...
import app.main.wangliwei.baselib.widgets.gesture.listener.OnGestureLockListener;
import app.main.wangliwei.baselib.widgets.gesture.model.Point;
import app.main.wangliwei.baselib.widgets.gesture.painter.CustomLockPainter;
import app.main.wangliwei.baselib.widgets.gesture.painter.Painter;
...
public class GestureLockView extends View {
     ...
     */
    private Painter mPainter = new CustomLockPainter();
    ...
    private void initAttrs(Context context, AttributeSet attrs) {
        ...
        mLineThickness = array.getDimensionPixelSize(R.styleable.GestureLockView_line_thickness, DensityUtil.dp2px(1));
