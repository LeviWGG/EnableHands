...
import app.main.wangliwei.baselib.widgets.gesture.GestureLockView;
import app.main.wangliwei.baselib.widgets.gesture.model.Point;
import app.main.wangliwei.baselib.widgets.gesture.util.GestureBitmapUtil;
...
public abstract class Painter {
    ...
    public void setNormalBitmap(Context context, int radius, int normalImageId) {
        if (normalImageId != 0) {
            mNormalBitmap = GestureBitmapUtil.createScaledCircleBitmap(context, radius, normalImageId);
        } else {
            mNormalBitmap = null;
        }
    }
    ...
    public void setPressBitmap(Context context, int radius, int pressImageId) {
        if (pressImageId != 0) {
            mPressBitmap = GestureBitmapUtil.createScaledCircleBitmap(context, radius, pressImageId);
        } else {
            mPressBitmap = null;
        }
    }
    ...
    public void setErrorBitmap(Context context, int radius, int errorImageId) {
        if (errorImageId != 0) {
            mErrorBitmap = GestureBitmapUtil.createScaledCircleBitmap(context, radius, errorImageId);
        } else {
            mErrorBitmap = null;
        }
    }
